...
1. The 'main' texture, which is just the normal wall, including the borders.
2. The 'empty' texture, which contains the inner part of the wall.
 ...
 * @param empty {Object} the 'empty' sprite
 * @param corners {Object} the 'corners' sprite
 */
function generateConnectedTextures(main, empty, corners) {
  // first, create a common color palette.
  var colors = main.colors;
  adjustColors(colors, empty);
